...
class BlockchainController {
    ...
    _print_blockchain() {
        this.blockchain.chain.forEach((block, idx) =>
        {
            let body = hex2ascii(block.body);
            body = JSON.parse(body);
            this.blockchain.chain[idx].body2 = body;
    ...
    // This endpoint allows you validate de chain integrity
    validateChain() {
